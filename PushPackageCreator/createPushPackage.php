...
$certificate_path = "/Users/anupamamishra/Documents/WPN/PushPackageCreater/Certificates.p12";
$certificate_password = "17291729"; // Change this to the certificate's import password
...
function create_signature($package_dir, $cert_path, $cert_password) {
    ...
    openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "/Users/anupamamishra/Documents/WPN/PushPackageCreater/AWDRCA.pem");
